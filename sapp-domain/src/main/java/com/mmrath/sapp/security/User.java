...
public class User extends BaseEntity {
    ...
    @Id
    @TableGenerator(name = "userIdGen", table = "SEQUENCE_TABLE", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_VALUE", pkColumnValue = "USER_ID_SEQ", initialValue = 101, allocationSize = 1)
