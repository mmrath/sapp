...
public class Role extends BaseEntity {
    ...
    @Id
    @TableGenerator(name = "roleIdGen", table = "SEQUENCE_TABLE", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_VALUE", pkColumnValue = "ROLE_ID_SEQ", initialValue = 101, allocationSize = 1)
